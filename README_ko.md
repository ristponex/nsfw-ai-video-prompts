...
|:-----|:-----|:-----|:-------|:-----|:----------|:---------|
| **Wan 2.2 Spicy** | I2V / I2V-LoRA | **$0.03**/요청 | 480p, 720p | 5초, 8초 | 완전 무제한 | 저비용 익스플리시트 콘텐츠 |
| **Wan 2.5** | I2V / T2V | ~$0.05/요청 | 720p, 1080p | 5초, 10초 | 누드 + 중간 수준 익스플리시트 | 중간 품질 |
| **Wan 2.6** | I2V / T2V | $0.07/요청 | 최대 1080p | 5–15초 | 누드 (제한적 익스플리시트) | 고품질 아티스틱 누드 |
| **Seedance v1.5 Pro** | T2V / I2V | **$0.222**/요청 | 720p | 5–15초 | 화이트리스트 NSFW | 프리미엄 시네마틱 품질 |
| **Vidu Q3-Pro** | T2V / I2V | **$0.06**/요청 | 720p, 1080p | 5–10초 | 화이트리스트 NSFW | 품질/가격 균형 |
| **Kling v3.0 Pro** | T2V / I2V | **$0.204**/요청 | 최대 1080p | 5–10초 | 화이트리스트 NSFW | 모션 품질, 얼굴 |
...
### Wan 2.2 Spicy — 익스플리시트 콘텐츠 최적 ($0.03/요청)
...
### Wan 2.5/2.6 — 고품질 누드의 가성비 최강 ($0.05–$0.07/요청)
...
### Seedance v1.5 Pro — 프리미엄 시네마틱 품질 ($0.222/요청)
...
### Kling v3.0 Pro — 최고의 얼굴 품질 ($0.204/요청)
