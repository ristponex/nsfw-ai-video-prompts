...
|:-------|:-------|:-----|:-------|:---------|:-----------|:---------|
| **Wan 2.2 Spicy** | I2V / I2V-LoRA | **$0.03**/リクエスト | 480p, 720p | 5秒, 8秒 | 完全無制限 | 低コストのエクスプリシットコンテンツ |
| **Wan 2.5** | I2V / T2V | ~$0.05/リクエスト | 720p, 1080p | 5秒, 10秒 | ヌード＋中程度のエクスプリシット | 中品質 |
| **Wan 2.6** | I2V / T2V | $0.07/リクエスト | 最大1080p | 5–15秒 | ヌード（限定的エクスプリシット） | 高品質アーティスティックヌード |
| **Seedance v1.5 Pro** | T2V / I2V | **$0.222**/リクエスト | 720p | 5–15秒 | ホワイトリストNSFW | プレミアムシネマティック品質 |
| **Vidu Q3-Pro** | T2V / I2V | **$0.06**/リクエスト | 720p, 1080p | 5–10秒 | ホワイトリストNSFW | 品質/価格のバランス |
| **Kling v3.0 Pro** | T2V / I2V | **$0.204**/リクエスト | 最大1080p | 5–10秒 | ホワイトリストNSFW | モーション品質、顔 |
...
### Wan 2.2 Spicy — エクスプリシットコンテンツに最適（$0.03/リクエスト）
...
### Wan 2.5/2.6 — 高品質ヌードのコスパ最強（$0.05–$0.07/リクエスト）
...
### Seedance v1.5 Pro — プレミアムシネマティック品質（$0.222/リクエスト）
...
### Vidu Q3-Pro — 品質/価格バランス（$0.06/リクエスト）
...
### Kling v3.0 Pro — 最高の顔品質（$0.204/リクエスト）
